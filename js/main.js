...
//////////////////// my-slider    //////////////////
var mySlider = new Swiper(".my-slider-slider .swiper-container", {
  loop: true,
  autoplay: true,
  pagination: {
      el: ".my-slider-slider .swiper-pagination",
      clickable: true,
  },
  navigation: {
      nextEl: ".my-slider-slider .swiper-btn-next",
      prevEl: ".my-slider-slider .swiper-btn-prev",
  },
  breakpoints: {
      0: {
          slidesPerView: 1,
